...
class ConfigDialog( wx.Dialog):
    ...
    def __init__(self,config,*args,**kwargs):
        ...
        txt = wx.StaticText(self.contPanel, pos=self.contPos(),
            label = lt("'block' mode always blocks original key.") )
        self.addText( '' )
        txt = wx.StaticText(self.contPanel, pos=self.contPos(),
            label = lt("'longblock' mode only blocks when pressed longer or as GeeKey.") )
